...
export interface AuthGettersTypes {
  getCurrentUser(state: AuthStateTypes): object;
}

export type AuthMutationsTypes<S = AuthStateTypes> = {
  [AuthMTypes.SET_USER](state: S, payload: object): void;
...
export interface AuthActionTypes {
  ...
  // [AuthATypes.GET_USER_DISPATCH]({ commit }: AugmentedActionContextAuth): void;
  [AuthATypes.RESET_USER_DISPATCH]({
    commit,
  }: AugmentedActionContextAuth): void;
}
